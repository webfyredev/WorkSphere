...
export default function NavBar(){
    ...
    return(
        <>
            ...
            <div className='w-auto md:w-125 h-full flex flex-row justify-evenly items-center md:mr-10 overflow-hidden relative'>
                ...
                <button className='md:hidden cursor-pointer text-white p-4 mr-5' onClick={() => setIsOpen(!isOpen)}>{isOpen ? <X size={30}/> : <Menu size={30} />}</button>
                {isOpen  && (
                    <div className='absolute top-16 left-0 w-full h-50 bg-linear-to-r from-blue-500 to-blue-600 flex md:hidden z-1 border-1 border-red-500'>
                        <ul className='flex flex-col space-y-5 p-6 font-medium'>
                            ...
                            <li>
                                <Link to="/jobs" className='px-8 py-2.5 text-sm text-white text-bold hover:bg-blue-600 hover:rounded-sm bg-blue-500/30 rounded-sm'>Jobs</Link>
                            </li>
                            <li>
                                <Link to="/contacts" className='px-8 py-2.5 text-sm text-white text-bold hover:bg-blue-600 hover:rounded-sm bg-blue-500/30 rounded-sm'>Contacts</Link>
                            </li>
                            <li>
                                <Link to="/register" className='px-8 py-2.5 text-sm text-white text-bold hover:bg-blue-600 hover:rounded-sm bg-blue-500/30 rounded-sm'>Sign Up</Link>
                            </li>
