    ...
    return (
        <>
            <div className="w-full h-90 md:h-110 relative mb-5">
                ...
                <div className='absolute w-full h-full inset-0 bg-black/50 flex  flex-col items-center justify-center p-10'>
                    <motion.h3 {...ScrollUp} className='text-xl sm:text-3xl md:text-4xl text-white font-semibold mb-3 text-center'>{props.title}</motion.h3>
